...
var Content = function (_NativeBaseComponent) {
	_inherits(Content, _NativeBaseComponent);
	...
	_createClass(Content, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_extends({}, this.prepareRootProps(), { contentContainerStyle: contentContainerStyle }),
				this.props.children
			);
		}
	}]);

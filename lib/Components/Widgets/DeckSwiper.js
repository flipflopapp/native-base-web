...
var DeckSwiper = function (_NativeBaseComponent) {
    ...
    _createClass(DeckSwiper, [{
        ...
        value: function goToPrevious() {
            var currentPersonIdx = this.props.dataSource.indexOf(this.state.selectedItem);
            var newIdx = currentPersonIdx - 1;
            var newIdx2 = currentPersonIdx - 2;
        ...
        value: function componentWillMount() {
            ...
            this._panResponder = _reactNative.PanResponder.create({
                ...
                onPanResponderMove: _reactNative.Animated.event([null, { dx: this.state.pan.x, dy: this.state.pan.y }]),
        ...
        value: function render() {
            ...
            var opacity = pan.x.interpolate({ inputRange: [-120, 0, 120], outputRange: [0.5, 1, 0.5] });
            // let scale = enter;
            ...
            return _react2.default.createElement(
                ...
                this.state.selectedItem === undefined ? _react2.default.createElement(_View2.default, null) : _react2.default.createElement(
                    _View2.default,
                    null,
                    ...
                    _react2.default.createElement(
                        ...
                        _extends({ style: [animatedCardStyles, { marginTop: -416, elevation: 3 }] }, this._panResponder.panHandlers),

...
var Textarea = function (_NativeBaseComponent) {
	_inherits(Textarea, _NativeBaseComponent);
	...
	_createClass(Textarea, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				_reactNative.View,
				{ style: { flex: 1 } },
				_react2.default.createElement(_reactNative.TextInput, _extends({}, this.prepareRootProps(), { multiline: true, placeholderTextColor: this.getTheme().inputColorPlaceholder, underlineColorAndroid: 'rgba(0,0,0,0)' }))
			);
		}
	}]);

...
var SpinnerNB = function (_NativeBaseComponent) {
    _inherits(SpinnerNB, _NativeBaseComponent);

    function SpinnerNB() {
        _classCallCheck(this, SpinnerNB);

        return _possibleConstructorReturn(this, (SpinnerNB.__proto__ || Object.getPrototypeOf(SpinnerNB)).apply(this, arguments));
    }

    _createClass(SpinnerNB, [{
        ...
        value: function render() {
            return _react2.default.createElement(_reactNative.ActivityIndicator, _extends({}, this.prepareRootProps(), { color: this.props.color ? this.props.color : this.props.inverse ? this.getTheme().inverseSpinnerColor : this.getTheme().defaultSpinnerColor,

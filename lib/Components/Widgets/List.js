...
var ListNB = function (_NativeBaseComponent) {
    ...
    function ListNB() {
        ...
        return _possibleConstructorReturn(this, (ListNB.__proto__ || Object.getPrototypeOf(ListNB)).apply(this, arguments));
    }
    ...
    _createClass(ListNB, [{
        ...
        value: function render() {
            if (this.props.dataArray && this.props.renderRow) {
                ...
                return _react2.default.createElement(_reactNative.ListView, _extends({}, this.prepareRootProps(), {

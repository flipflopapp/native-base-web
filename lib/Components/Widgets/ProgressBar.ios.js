...
var ProgressBarNB = function (_NativeBaseComponent) {
	_inherits(ProgressBarNB, _NativeBaseComponent);
	...
	_createClass(ProgressBarNB, [{
		...
		value: function render() {
			return _react2.default.createElement(_reactNative.ProgressViewIOS, { progress: this.props.progress ? this.props.progress / 100 : 0.5,
				progressTintColor: this.props.color ? this.props.color : this.props.inverse ? this.getTheme().inverseProgressColor : this.getTheme().defaultProgressColor });
		}
	}]);
